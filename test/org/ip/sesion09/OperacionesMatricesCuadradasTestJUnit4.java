...
public class OperacionesMatricesCuadradasTestJUnit4 {
	...
	public void setUp() throws Exception {
	 ...
	 String salidaMatriz =
	 OperacionesMatricesCuadradas.muestraMatriz(matrizA);
	 ...
	 OperacionesMatricesCuadradas.transpuesta(matrizC);
	 salidaMatriz =
	 OperacionesMatricesCuadradas.muestraMatriz(matrizTraspuesta);
	 salidaEsperadaMatriz = "Matriz:" + "\n"
	 + "3	6	9" + "\n"
	 + "6	3	21" + "\n"
	 + "9	21	3";
	 ...
	 assertTrue(simetrica);
	 boolean equal = OperacionesMatricesCuadradas.equals(matrizC,
	 matrizTraspuesta);
	 assertTrue(equal);
	
	 int [] sumaFilas = OperacionesMatricesCuadradas.sumaFilas(matrizC);
	 String salidaArray =
	 OperacionesMatricesCuadradas.muestraArray(sumaFilas);
	 ...
	 int [] menorElemento =
	 OperacionesMatricesCuadradas.elementoMenor(matrizC);
	 assertTrue(menorElemento[0] == 0); assertTrue(menorElemento[1] == 0);
	 assertTrue(menorElemento[2] == 3);
	
	 int [] mayorElemento =
	 OperacionesMatricesCuadradas.elementoMayor(matrizC);
	 assertTrue(mayorElemento[0] == 1); assertTrue(mayorElemento[1] == 2);
	 assertTrue(mayorElemento[2] == 21);
	 ...
	 int [][] matrizC;
	 int [][] matrizD = {{35, 7, 20, 3}, {26, 7, 28, 9}, {16, 37, 33, 10},
	 {13, 27, 36, 48}};
	 ...
	 int [] menorElemento =
	 OperacionesMatricesCuadradas.elementoMenor(matrizC);
	 assertTrue(menorElemento[0] == 0); assertTrue(menorElemento[1] == 3);
	 assertTrue(menorElemento[2] == 21);
	
	 int [] mayorElemento =
	 OperacionesMatricesCuadradas.elementoMayor(matrizC);
	 assertTrue(mayorElemento[0] == 3); assertTrue(mayorElemento[1] == 3);
	 assertTrue(mayorElemento[2] == 336);
